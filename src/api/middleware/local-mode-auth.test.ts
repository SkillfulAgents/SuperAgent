...
describe('isContainerFacingPath', () => {
  ...
  it('bypasses the replicate lane', () => {
    expect(isContainerFacingPath('/api/replicate/catalog')).toBe(true)
    expect(isContainerFacingPath('/api/replicate/v1/predictions')).toBe(true)
  })
