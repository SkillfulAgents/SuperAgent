...
import xAgentIntegrationTools from './routes/x-agent-integration-tools'
...
import chatIntegrationsRouter from './routes/agent-integration-crud'
...
app.route('/api/x-agent/integration-tools', xAgentIntegrationTools)
