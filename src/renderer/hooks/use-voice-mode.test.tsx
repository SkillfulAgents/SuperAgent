...
vi.mock('@renderer/lib/voice/shared/listener', () => ({
  VoiceListener: class {
    utterance = ''
    analyser = null
    start = vi.fn(async () => {})
...
vi.mock('@renderer/lib/voice/shared/read-aloud', () => ({ readAloud: reader, voiceStreamId: (sessionId: string) => `voice:${sessionId}` }))
...
import { INTERRUPT_WORD_THRESHOLD, LISTENER_RESTART_MS, DUCK_MAX_MS, CHAINED_TURN_POLICY } from '@renderer/lib/voice/engines/chained-conversation'
