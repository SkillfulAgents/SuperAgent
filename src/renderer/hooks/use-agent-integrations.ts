...
export type { PublicAgentIntegration as ChatIntegration } from '@shared/lib/agent-integrations/public'
 ...
 *  connector page uses. */
export type AgentIntegrationListItem = ChatIntegration & { connected: boolean }
