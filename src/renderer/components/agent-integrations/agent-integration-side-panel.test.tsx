...
describe('AgentIntegrationSidePanel', () => {
  it('shows Status, Settings and Model for managers', () => {
    render(<AgentIntegrationSidePanel integration={makeChatIntegration()} canManage canManageAccess />)
  ...
  it('hides the manager cards for viewers', () => {
    render(<AgentIntegrationSidePanel integration={makeChatIntegration()} canManage={false} canManageAccess={false} />)
