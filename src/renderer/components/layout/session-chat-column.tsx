    ...
    <SessionThread
      ...
      footer={
        <>
          ...
          {/* Kept mounted behind a request card or a blocking provider error, just
              hidden: what it holds (a draft, voice mode) survives. Voice mode pauses
              for either and picks the agent's turn back up once it is gone. */}
