...
export const linearDefinition: AgentIntegrationDefinition = {
  ...
  capabilities: ['issue_sessions', 'mentions', 'delegation', 'task_tools', 'final_comments'],
  settings: [{ key: 'runOnStatusChange', label: 'Run when an involved issue changes status', type: 'boolean' }],
  setup: { kind: 'private-oauth-app', credentialFields: ['clientId', 'clientSecret', 'webhookSecret'] },
}
