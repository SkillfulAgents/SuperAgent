...
export function buildAutomatedSessionPrompt(kind: AutomatedSessionKind): string {
  ...
  return `This session was started automatically by ${startedBy}. Nobody is watching this session live. Text you write here is unread unless you deliver it through the channel the task specifies. Once a user replies in this session, it is interactive: drop these assumptions and converse normally.
