...
After completing the test, your response MUST end with a JSON block:
...
The test runner parses this JSON to determine pass/fail. If you cannot find it, the test is marked as failed.
