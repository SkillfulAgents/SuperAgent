...
// Question is passed via Workflow({name: 'gamut:deep-research', args: '<question>'}).
...
if (!QUESTION) {
  return { error: "No research question provided. Pass it as args: Workflow({name: 'gamut:deep-research', args: '<question>'})." }
}
