...
Common toolkits include gmail, slack, github, notion, linear, salesforce, and many more. Use search_services to discover all available services and their toolkit slugs.`,
  {
    toolkit: z
      .string()
      .describe(
